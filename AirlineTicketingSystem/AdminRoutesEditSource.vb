Public Class AdminRoutesEditSource

    Private Sub AdminRoutesEditSource_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        For Each city In cities
            ...
            cityAddItem.Form = "AdminRoutesEditSource"
            cityAddItem.City = city
            cityAddItem.AdminRoutesEditSource = Me
